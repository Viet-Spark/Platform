...
{:else}
		...
		>
			<div>
				<div class="mb-2 flex items-center gap-3">
					...
					<div>
						<p class="text-gray-97 uppercase text-base">2026 Vietnam</p>
							...
							>
								...
								{:else if item.icon === 'relationships'}
									<svg width="19" height="17" viewBox="0 0 19 17" fill="none" xmlns="http://www.w3.org/2000/svg">
										<path d="M5.09945 5.86544L9.43278 1.5321L13.7661 5.86544L18.0994 1.5321M0.766113 10.1988L5.09945 14.5321L9.43278 10.1988L13.7661 14.5321L18.0994 10.1988" stroke="#0B57BD" stroke-width="2.16667"/>
									</svg>
									
								{:else if item.icon === 'trend'}
									<svg width="21" height="26" viewBox="0 0 21 26" fill="none" xmlns="http://www.w3.org/2000/svg">
										<path d="M11.9166 2.16663L2.16663 15.1666H9.74996L8.66663 23.8333L18.4166 10.8333H10.8333L11.9166 2.16663Z" stroke="#0B57BD" stroke-width="2.16667"/>
									</svg>
									
								{:else if item.icon === 'search'}
									<svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
										<path d="M11.9166 19.5C16.1047 19.5 19.4999 16.1049 19.4999 11.9167C19.4999 7.72855 16.1047 4.33337 11.9166 4.33337C7.72843 4.33337 4.33325 7.72855 4.33325 11.9167C4.33325 16.1049 7.72843 19.5 11.9166 19.5Z" stroke="#0B57BD" stroke-width="2.16667"/>
										<path d="M22.7499 22.75L18.0916 18.0917" stroke="#0B57BD" stroke-width="2.16667"/>
									</svg>																	
								{/if}
							</div>
							<div>
	...
	<section class="bg-white py-24">
		<div class="container mx-auto px-4">
			...
			<div class="mx-auto mt-8 grid max-w-6xl gap-5 grid-cols-2">
				<div
					class="rounded-[24px] border border-[#D7E2F0] bg-white px-7 py-7"
				>
					<div
				...
				>
					...
					<div class="my-1.5 ext-[13.5px] leading-[20.25px] font-semibold text-[#B7D4FF]">
