	...
	<div class="container mx-auto px-4">
		...
		<div class="mx-auto max-w-3xl">
			<div class="space-y-6">
				...
				<div class="rounded-lg bg-white p-6 shadow-sm">
					<h3 class="mb-2 text-xl font-bold">Are your events only for Vietnamese professionals?</h3>
					<p class="text-gray-600">
						While we focus on supporting Vietnamese professionals, our events and resources are open
						to everyone who is interested in our mission and wants to engage with our community.
					</p>
				</div>
				...
				<div class="rounded-lg bg-white p-6 shadow-sm">
					<h3 class="mb-2 text-xl font-bold">Is VietSpark a non-profit organization?</h3>
					<p class="text-gray-600">
						Yes, VietSpark is a registered non-profit organization dedicated to supporting
						Vietnamese professionals in the tech industry through education, mentorship, and
						community building.
					</p>
				</div>
			</div>
